...
class LegalLocust(HttpUser):
    ...
    def get_clients_list_depth_1(self):
        self.client.get("/custodian/data/client?depth=1", headers=self.headers)
    ...
    def get_employee_position(self):
        self.client.get("/custodian/data/employee_position/1", headers=self.headers)

    @task(10)
    def get_employee_positions(self):
        self.client.get("/custodian/data/employee_position?depth=1", headers=self.headers)

    @task(10)
    def get_employee_positions_d2(self):
        self.client.get("/custodian/data/employee_position?depth=2", headers=self.headers)

    @task(20)
    def get_documents_d1(self):
        self.client.get("/custodian/data/document?depth=1", headers=self.headers)

    @task(20)
    def get_documents_d2(self):
        self.client.get("/custodian/data/document?depth=2", headers=self.headers)
